package com.padcmyanmar.padcx.customprofile.views.components
...
class CircleImageView @JvmOverloads constructor(
    ...
    init {
        ...
        borderColor = attributes.getColor(R.styleable.CircleImageView_civ_border_color, Color.WHITE)
        borderWidth = attributes.getDimension(R.styleable.CircleImageView_civ_border_width, 0f)
    }
